...
export default function Footer() {
  ...
  const quickLinks = [
    { label: "Autism Assessment", href: "#assessment" },
    { label: "Autism Coaching", href: "#coaching" },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-background/70 leading-relaxed max-w-md mb-6">
              Melbourne's trusted psychology clinic providing comprehensive autism assessment 
