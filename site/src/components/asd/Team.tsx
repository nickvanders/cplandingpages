  ...
  const teamFeatures = [
    {
      ...
      description: "Our psychologists use evidence-based, neuroscience-focussed approaches to accurately assess and support autistic adults and adolescents.",
    },
    {
      icon: Heart,
      title: "Compassionate Care",
      description: "We provide a sensory-friendly environment with collaborative, non-judgmental care tailored to your unique needs.",
    },
    {
      icon: Sparkles,
    ...
    },
    {
      ...
      description: "Our team of registered psychologists have extensive experience in autism assessment, coaching, and support for co-occurring conditions.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-semibold text-foreground mb-4">
            Quality Autism Care in Melbourne
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Contemporary Psychology brings together accredited psychologists with extensive 
            experience in autism assessment, diagnosis, and evidence-based support.
          </p>
        </div>
