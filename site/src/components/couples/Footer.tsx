...
const logoImage = "/assets/Screenshot_2025-12-04_at_1.58.41_pm-removebg-preview_1764817148139.png";
...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { label: "What We Help With", href: "#skills" },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-background/70 leading-relaxed max-w-md mb-6">
              Melbourne's trusted psychology clinic providing evidence-based couples counselling 
              services. Strengthen your relationship with Gottman Method therapy. 
              In-person at St Kilda and online Australia-wide.
            </p>
