      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-32">
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 max-w-xl">
            Evidence-based ADHD assessments and personalised coaching programs in Melbourne. 
            No referral required. Medicare rebates available for screening and coaching. Take the first step today.
          </p>
